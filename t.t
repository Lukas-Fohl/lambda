...
{
    arena* ret = (arena*)malloc(size + sizeof(arena));
    ret->reserved = size + sizeof(arena);
    ret->used = 0 + sizeof(arena);
    return ret;
}
...
{
    if (arenaIn->used - size >= sizeof(arena)) {
        arenaIn->used -= size;
        void* ret = (char*)arenaIn + arenaIn->used;
        return ret;
    }
...
# 35 "main.c"
typedef struct dyn_long dyn_long; dyn_long dyn_long_create(size_t maxLen); 
# 35 "main.c" 3 4
_Bool 
# 35 "main.c"
dyn_long_push(dyn_long* listIn, long element); long dyn_long_get(dyn_long* listIn, size_t idx); 
# 35 "main.c" 3 4
_Bool 
# 35 "main.c"
dyn_long_set(dyn_long* listIn, size_t idx, long value); size_t dyn_long_len(dyn_long* listIn); 
# 35 "main.c" 3 4
_Bool 
# 35 "main.c"
dyn_long_remove(dyn_long* listIn, size_t idx);
struct dyn_long { size_t cLen; size_t maxLen; long* content; }; dyn_long dyn_long_create(size_t maxLen) { dyn_long temp; temp.content = (long*)calloc(maxLen, sizeof(long)); temp.maxLen = maxLen; temp.cLen = 0; return temp; } 
# 36 "main.c" 3 4
_Bool 
# 36 "main.c"
dyn_long_push(dyn_long* listIn, long element) { if (listIn->maxLen == 0 || listIn->content == 
# 36 "main.c" 3 4
((void *)0)
# 36 "main.c"
) return 
...
0
# 36 "main.c"
; if (listIn->cLen < listIn->maxLen) { listIn->content[listIn->cLen] = element; listIn->cLen++; return 
# 36 "main.c" 3 4
1
# 36 "main.c"
; } while (listIn->cLen >= listIn->maxLen) { listIn->content = (long*)realloc(listIn->content, 2 * listIn->maxLen * sizeof(long)); if (listIn->content != 
# 36 "main.c" 3 4
((void *)0)
# 36 "main.c"
) { listIn->maxLen *= 2; } else { return 
# 36 "main.c" 3 4
0
# 36 "main.c"
; } } return dyn_long_push(listIn, element); } long dyn_long_get(dyn_long* listIn, size_t idx) { if (idx > listIn->maxLen - 1) giveUp("list out of bound"); if (listIn->content == 
# 36 "main.c" 3 4
((void *)0)
# 36 "main.c"
) giveUp("list content empty"); return listIn->content[idx]; } 
# 36 "main.c" 3 4
_Bool 
# 36 "main.c"
dyn_long_set(dyn_long* listIn, size_t idx, long value) { if (idx > listIn->maxLen - 1 || listIn->content == 
# 36 "main.c" 3 4
((void *)0)
# 36 "main.c"
) return 
...
0
# 36 "main.c"
; listIn->content[idx] = value; return 
# 36 "main.c" 3 4
1
# 36 "main.c"
; } size_t dyn_long_len(dyn_long* listIn) { return listIn->cLen; } 
# 36 "main.c" 3 4
_Bool 
# 36 "main.c"
dyn_long_remove(dyn_long* listIn, size_t idx) { if (listIn->maxLen == 0 || listIn->cLen == 0 || idx >= listIn->cLen || idx >= listIn->maxLen || listIn->content == 
# 36 "main.c" 3 4
((void *)0)
# 36 "main.c"
) return 
...
0
# 36 "main.c"
; for (size_t i = idx; i < listIn->cLen - 1; i++) { long temp = dyn_long_get(listIn, i + 1); dyn_long_set(listIn, i, temp); } listIn->cLen -= 1; return 
# 36 "main.c" 3 4
1
# 36 "main.c"
; }
...
int main(void)
{
    ...
    dyn_long b = dyn_long_create(5);
    for (int i = 0; i < 10; i++) {

        dyn_long_push(dyn_long* &b, long i);
        printf("%lu\n",dyn_long_len(&b));
    }
    for (int i = 0; i < 10; i++) {
        printf("%ld\n", dyn_long_get(&b, i));
